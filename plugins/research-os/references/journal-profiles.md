...
Used by: domain-referee.md, methods-referee.md (via /peer-review --peer [journal])
-->

## How This Works

When `/peer-review --peer [journal]` is invoked:
...
4. **Profile NOT found** → referees use the journal name + `00_admin/domain-profile.md` to adapt (still better than generic)
