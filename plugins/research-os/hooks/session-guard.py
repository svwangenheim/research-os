...
Reads guard configuration from .claude/state/session-guards.json (project-local
runtime state, not shipped by the plugin).
...
def check_freeze(tool_name: str, tool_input: dict, guards: dict) -> tuple:
    ...
    # Check against allowed paths (numbered scheme: 00_admin, 01_literature,
    # 02_data, 03_analysis, 04_paper, 05_outreach, explorations, ARCHIVE)
