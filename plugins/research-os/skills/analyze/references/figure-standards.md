...
```r
ggsave(
  here("04_paper", "academic_paper", "figures", "fig_event_study.pdf"),
  plot = p,
  width = 6,
  height = 4,
...
ggsave(
  here("04_paper", "academic_paper", "figures", "fig_main.pdf"),
  plot = p,
  width = 6, height = 4
)
...
ggsave(
  here("04_paper", "academic_paper", "figures", "map_treatment.png"),
  plot = p_map,
