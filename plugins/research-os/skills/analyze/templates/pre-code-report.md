...
**Coding standards:** [R / Python / Julia — field conventions from `00_admin/domain-profile.md`; table/figure standards from `${CLAUDE_PLUGIN_ROOT}/skills/analyze/references/`]
