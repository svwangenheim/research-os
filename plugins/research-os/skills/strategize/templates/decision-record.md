...
**Purpose:** Document the identification strategy decision with alternatives considered and rationale. Saved to `00_admin/process/decisions/`. Enables traceability and helps the writer explain design choices.
