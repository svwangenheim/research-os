...
- Voice fidelity (writer-critic category 7) is only scored when `00_admin/personal-style-guide.md` has real content. If the style guide is still a template, skip and report.
...
- Theorist-critic should not lecture authors on their own methods. Check `00_admin/domain-profile.md` for the paper's authors before flagging textbook issues.
