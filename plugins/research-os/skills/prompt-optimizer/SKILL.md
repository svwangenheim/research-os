...
description: Analyze a raw prompt, identify intent and gaps, and output a ready-to-paste optimized prompt. Advisory only. Use on "optimize prompt", "improve my prompt", "how do I prompt for".
argument-hint: "[the raw prompt you want optimized]"
origin: community
metadata:
  author: YannJY02
  version: "1.0.0"
