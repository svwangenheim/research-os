---
name: revise
description: R&R cycle — classify referee comments, route them to agents, draft the response letter, and audit it before it goes back. Writes to 04_paper/revisions/. Use when referee reports arrive, or on "respond to referees", "handle this R&R".
