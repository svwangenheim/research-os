...
10. Record every paper in `passport.yaml` `literature_corpus` (bibkey, title, proximity, `citation_status: relevant`, `wiki_path` if summarized) and refresh the `wiki-links.md` source table.
