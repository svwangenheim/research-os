#!/usr/bin/env python3
"""
Generate self-contained HTML detail reports from research-os markdown reports.
...
Reports are arg-driven (paths passed on the CLI). Base CSS/JS are read from the
plugin's styles/ directory. Report inputs live under 04_paper/reviews/ and
literature reviews under 01_literature/reviews/ (see rules/folder-map.md).

Usage:
    python3 scripts/generate_html_report.py peer-review \
        04_paper/reviews/YYYY-MM-DD_referee_domain.md \
        04_paper/reviews/YYYY-MM-DD_referee_methods.md \
        04_paper/reviews/YYYY-MM-DD_editorial_decision.md \
        [--output 04_paper/reviews/YYYY-MM-DD_peer_review.html]
"""
