# Wiki Links — <Project Title>

Bridge between this project and the thematic wiki(s). Refreshed by `/wiki-pull`, `/wiki-push`, `/checkpoint`. Reflected in `project_dashboard.html`.

**Main wiki:** `<theme>` · **Last sync:** `<YYYY-MM-DD>`
...
- [[<theme>/30_concepts/<concept>]] — <why relevant to this project>

## Methods

- [[<theme>/40_methods/<method>]] — <why relevant>

## Datasets

- [[<theme>/50_datasets/<dataset>]] — <why relevant>

## Related projects

- [[_brain/projects/<other-slug>]] — <relationship>

## To push back to the wiki / brain
